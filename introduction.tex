...
sensibilities regarding what makes a good story; at the very least I hope it contains some
scintilla of sense, maybe even an estimate of erudition.
%
...
%
In the second chapter, we consider a relaxed version of the problem -- this time, couched in
non-AF-centric manner -- which is soluble using supplementary data that is unannotated in the
truest sense, in that neither the sensitive -- here, `subgroup' -- nor target annotations are
provided.
%
