...
by which the embers of \acf{USL} have been stoked, into what has become a bustling blaze of
...
we tread in \acf{SemiSl}'s domain.
%
...
fully-supervised ones which \cite{SagWeiLeeGaoetal22} showed many existing \ac{SemiSL} methods
failed to do, and, as in Chapter \ref{ch:nifr}, it comes with a valuable interpretable aspect,
conferred by the trained-with matching algorithm.
