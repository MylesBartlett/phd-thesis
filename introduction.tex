...
%
\section{On humble themes and living chairs}\label{sec:themes}
%
...
topics I think relevant to the works that constitute the `middle' and marrow of thesis.
%
...
context of more recent developments in the germane fields, as well as ponder future avenues of work
in similar vain.
%
...
%
Here, we consider a setup in which sampling bias induces a one-to-one correspondence
