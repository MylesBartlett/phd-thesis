...
% ********************************************************************************
%
Given that this thesis references \acf{SemiSL}
%
\footnote{ 
  %
...
%
One is generally motivated to employ some form of \ac{SemiSL} in cases when \( N^{tr}_l \ll N^{tr}_u \),
...
%
On the perspective side, one can, for instance, view \ac{SemiSL} as \ac{USL} learning subject to
...
%
Closely related to \ac{SemiSL} is the idea of \emph{Transductive Learning} (TL), as pioneered by Vapnik
...
integrals.
%
A classical example of a \ac{SemiSL} method derived from this principle is Transductive Support Vector
...
\begin{equation}
 ...
 %
 This is capitalised on in Chapter 4 we propose a consistency-regularised method for \ac{DG} where pairs
