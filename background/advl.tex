...
% ********************************************************************************
\acf{AdvL} is a general, multi-field-spanning learning paradigm, describing -- in game-theoretical
parlance -- non-co{\"o}perative (competitive) systems, or `games' in which two or more `players'
compete over shared, or at least interdependent, \emph{utility} \citep{fudenberg1991game}.
%
