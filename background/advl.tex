...
%
For this, both players take the form of an \ac{NN} with strategies defined by their parameters --
...
\R \).
%
We note, incidentally, that due to the continuity and non-convexity of \ac{NN}s, it is unfortunately not
...
\begin{enumerate}
        ...
        \item 
          ...
          computational cost.
          %
          In Chapter \ref{ch:nifr} we consider this pitfall and propose a middle ground of training
          against a stochastic ensemble of adversaries.
         % 
\end{enumerate}
