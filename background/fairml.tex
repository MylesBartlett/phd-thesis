...
be \emph{fair}; in this thesis we focus on those corresponding to group definitions of fairness
...
interchangeably throughout the literature; we will favour the former).
%
...
groups.
%
Here, we briefly discuss and formulate \emph{\ac{DP}}, \emph{\ac{EqOp}}, and \emph{\ac{EqOd}} as
