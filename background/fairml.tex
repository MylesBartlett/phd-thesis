...
increased capacity to affect real lives in consequential ways -- in all sectors of society.
%
...
terms of the \acf{MI} between \(Y\) and \(S\), itself expressible as the KL divergence between the
joint and product of the marginal distributions:
%
\begin{equation}
...
set of \ac{PO} solutions, the discovery of which is the remit of multi-objective
...
%
In the \ac{DRO} literature (where ) this quantity is commonly known as \ac{RobAcc}.
%
