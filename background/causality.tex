...
shifted.
%
\marginpar{\textbf{The domain as an exogenous variable}}
%
...
A common \citep{arjovsky2019invariant, krueger2021out, sagawa2019distributionally} way of
formulating the robust-prediction problem is as one of bilevel, or minimax, optimisation, where the
inner loop entails computing the empirical risk over each domain and the outer loop corresponds to
