...
correlations.
%
We illustrate in Fig.~\ref{fig:ds_cbns} \acp{CBN} corresponding to different distribution shifts
for a causal prediction task.
%
...
A popular \citep{arjovsky2019invariant, krueger2021out, sagawa2019distributionally} and intuitive way
