...
%
\Aclp{SC}, or (statistical) shortcuts (I will use the terms interchangeably throughout), give rise
...
\ac{DRO} problem --  term, I attempt to unify them by invoking causal principles.
%
...
specific learning paradigms -- departing from the problem setups they can be applied to --
