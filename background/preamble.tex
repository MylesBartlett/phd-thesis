...
%
\acf{SC}s, or (statistical) shortcuts (we will use the terms interchangeably throughout), give rise
...
different ways) and the idea of \acf{SCL} has close ties to \ac{DG} \citep{arjovsky2019invariant},
...
causality \citep{pearl2009causality} provides, through \acf{CBG}s and interventions thereof, the
...
thesis, namely:  \ac{DA}, \ac{DG}, \ac{AF}, \ac{SemiSL}, \acf{AdvL}}, and \acf{INN}s.
