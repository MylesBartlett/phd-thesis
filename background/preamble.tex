...
\noindent
%
In this chapter, I compass to provide background on the topics encompassed by the works in this
thesis, both individually, and holistically.
%
...
the learning paradigms -- departing from the problem setups they can might be applied to-- featured
throughout the works in this thesis, namely \ac{SemiSL}, \ac{AdvL}, and \acp{INN}.
