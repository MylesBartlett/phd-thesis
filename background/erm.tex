...
Y)\). 
% often taken to be the (negative) Kullback-Leibler divergence, \( D_{KL} \) (also known as
...
the sum of the Kullback-Leibler (KL) Divergence (also known as the \emph{relative entropy}),
...
%
With the foregoing adjustments in mind, one can then define the standard ERM objective as
% %
