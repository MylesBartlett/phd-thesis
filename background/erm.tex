...
%
\textbf{First} the substitution of \( P^{tr}(X, Y) \) with its empirical counterpart, \( \gD^{tr}
...
%
\textbf{Second}, given the variables are deterministic rather than random, one can no longer frame
the optimisation objective in terms of a statistical distance explicitly. 
%
