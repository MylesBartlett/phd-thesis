...
\acfp{VAE}~\citep{kingma2013auto,louizos2016variational,edwards2016censoring,beutel2017data}. 
%
The achieved fairness of the representation can be measured with various fairness metrics. These
...
%
However, \ac{DP} is the most widely
...
because variables with \aclp{SC} do not represent a stable causal mechanism, the predictor learns
to be invariant to them.
%
...
correlations, with the benefit being that it need only be labelled \wrt{} $s$.
