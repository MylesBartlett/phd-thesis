...
%   }%
%   %\hfill
%   \subfloat[UCI Adult]{\scalebox{0.495}{\includegraphics[width=\textwidth]{nifr/Figures/nosinn_celeba_multiplot_all_landscape_Smiling.pdf}}
...
\begin{figure}[tb]
    ...
    % \includegraphics[width=0.9\textwidth]{nifr/Figures/cmnist_new.pdf}
...
% \begin{figure}
%   \centering
%   \includegraphics[width=0.7\textwidth]{nifr/Figures/nosinn_adult_multiplot_mini_diff.pdf}
%   \caption{
    %   Results for the \textsc{Adult} dataset.
    %   The $x$-axis corresponds to the difference in positive rates.
    %   An ideal result would occupy the \textsc{top-left}.
