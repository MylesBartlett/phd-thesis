...
% The next question is whether to use the \ac{cFlow} or cVAE variant of the method. For initial
...
% recommend switching to the \ac{cFlow} model once cVAE is working as it provides better guarantees
