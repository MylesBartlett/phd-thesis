...
Old/Male. 
%
To evaluate the fairness for multinomial $s$, we use \acf{HGRMC} \citep{mary2019fairness}, defined
on the domain $[0, 1]$ and yielding \( \text{HGR}(Y,S)=0 \) iff $Y \perp S$, \(1\) if there is a
deterministic mapping between the variables. 
%
