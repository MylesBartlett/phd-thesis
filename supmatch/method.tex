...
% Our goal is to make $z$ invariant to the subgroup $s$.
% However, what the adversarial loss actually enforces is that $z$ generates bags with the same support over $S \times Y$ irrespective of the dataset they were drawn from.
% To ensure that the disentangling aligns with our objective,
