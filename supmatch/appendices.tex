\section{Appendix}\label{sec:supmatch-appendix}
%
...
%
The MNIST dataset \citep{lecun1994mnist} consists of 70,000 (60,000 designated for training,
...
\begin{figure*}[htp]
    ...
    \caption{% The main components of our support-matching algorithm, $f$ (debiaser) and $h$
      ...
      %, thereby serving as an error signal for the debiaser. 
  ...
  % CORRECTION: could adjust minorly as per the viva
\end{figure*}%
%
