...
\usepackage[a4paper,top=2.5cm,bottom=2.5cm,left=3cm,right=3cm,headsep=10pt,marginparwidth=20mm,
margin=35mm]{geometry}
...
%
\ctparttext{
  This part comprises the introduction and background topics deemed relevant to
  part~\ref{pt:middle}.
...
\ctparttext{
  %
  This part comprises three publications, two peer-reviewed and published at top ML conferences,
  one forever work-in-progress (but is no less a paper for it, I might opine);
  %
  the former have been adapted for this thesis textually, with the view to improve clarity,
  technical correctness, and consistency (both internally and between works) but are limited in
  scope and the preponderance of the text remains as-published.
  %
