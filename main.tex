...
%   one a work-in-progress; the former have been adapted for this thesis textually, to improve
%   clarity, technical correctness, and consistency (both internally and between works) but are
%   limited in scope and the preponderance of the text remains as-published.
...
% \end{refsection}
% %
% \ctparttext{}\part{End}\label{pt:end}
% %
% \begin{refsection}[all]
%   \include{discussion}
%   \printbibliography
