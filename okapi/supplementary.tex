...
\section{Ablations}\label{appx:ablations}

\import{./}{tables/pm_ablations.tex}
...
\section{Pseudocode}\label{appx:pseudocode}

\import{./pseudocode/}{calipernn.tex}
\import{./pseudocode/}{ol.tex}
...
\section{Matching for PACS dataset}\label{appx:pacs_matching}
...
\begin{table}[ht!]
	...
	\begin{tabular}{llll} 
	\toprule 
    \textbf{Fixed Caliper ($t_f$)}  & \textbf{Temperature ($\tau$)} & \textbf{photo} $\rightarrow$ \textbf{sketch} & \textbf{sketch} $\rightarrow$ \textbf{photo} \\
    \midrule
    0.1 & 1 & 0 & 0 \\
    0 & 1 & 1540 & 3929 \\
    0.01 & 1 & 6 & 9 \\
