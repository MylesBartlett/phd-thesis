...
\begin{figure}[tbp]
  ...
  \caption{
    ...
    % CORRECTION: could add a little more detail on the steps here
}
...
%
  ...
  % CORRECTION: in a paper this detail would probably be in the body rather than the caption. I
  % would move  but better too much than too little!
\end{figure}
