...
\begin{figure}[tbp]
  ...
  \caption{
    ...
    %
    In the corresponding sub-figure above, the set of samples at this stage is singular, consisting
    ...
    %
    In the corresponding sub-figure above, exclusion by the std. caliper is denoted with a red
